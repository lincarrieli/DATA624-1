...
The caret package knn regression function found a minimum RMSE of 0.1432314 with a k value of 4.
...
The FNN knn regression gave a minimum RMSE of 0.1326044 with a k of 4. Unfortunately, it seems there are no differences in any of the methods...
...
This model found a minimum RMSE of 0.1190872 for a triangular kernel at a distance of 1 (Manhattan distance). This is much better than any of the other models so far, so I'm thinking this is the package to go with.
